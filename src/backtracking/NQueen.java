...
// https://www.acmicpc.net/problem/9663 NQueen
...
public class NQueen {
    ...
    // 몇번째 줄에 놓는지를 받아,
    // 해당하는 줄의 N개 중 하나에 Queen 을 놓고
    // 다음줄에 Queen 을 놓도록 재귀호출 하는 DFS
    private static void setQueenPos (
            // 몇번째 줄에 놓을 차례인지
            int row
    ) {
        // 마지막 줄까지 채웠다.
    ...
    private static boolean checkQueen(
        ...
        for (int i = 0; i < row; i++) {
            // 만약 같은 col에 있는 Queen이 배치된적 있다면 실패 (유망하지 않음)
